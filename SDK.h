...
{
public:
	class CEntList *EntList;
	class EngineClient *Engine;
	class IPanel *Panels;
	class ISurface *Surface;
	class ClientModeShared *ClientMode;
	class CHLClient *Client;
	class CModelInfo *ModelInfo;
	class CEngineTrace *Trace;
};
...
public:
	...
	bool GetPlayerInfo(int ent_num, struct player_info_t *pinfo)
	{
...
public:
	...
	{
		int index = hEnt & 0xFFF;
		//typedef CBaseEntity *(*OriginalFn)(void *, int);
		//return getvfunc<OriginalFn>(this, 4)(this, hEnt);
		return GetClientEntity(index);
	}
...
public:
    ...
    {
        typedef const char *(* OriginalFn)(void *, Model *);
        return getvfunc<OriginalFn>(this, 3)(this, model);
    }
    StudioModel GetStudiomodel(Model *model)
    {
        typedef StudioModel(* OriginalFn)(void *, Model *);
...
public:
    void TraceRay(const Ray_t &ray, unsigned int fMask,
                  class ITraceFilter *pTraceFilter, class trace_t *pTrace)
    {
        typedef void(* OriginalFn)(
            void *, const Ray_t &, unsigned int, ITraceFilter *, trace_t *);
        return getvfunc<OriginalFn>(this, 4)(this, ray, fMask, pTraceFilter,
                                             pTrace);
    }
};
...
struct mstudiohitboxset_t
{
	...
	int numhitboxes;
	int hitboxindex;
	mstudiobbox_t *pHitbox(int i) const { return (mstudiobbox_t *)(((uint8_t *)this) + hitboxindex) + i; };
};
...
public:
    ...
    uint8_t GetLifeState()
    {
        ...
        // return n.getValue( this );
        DYNVAR_RETURN(uint8_t, this, "DT_BasePlayer", "m_lifeState");
    }
    bool IsAlive() { return GetLifeState() == 0; }
    int GetTeam() { DYNVAR_RETURN(int, this, "DT_BaseEntity", "m_iTeamNum"); }
    int GetClass()
    {
        DYNVAR_RETURN(int, this, "DT_TFPlayer", "m_PlayerClass",
                      "m_iClass");
    }
    int GetFlags() { DYNVAR_RETURN(int, this, "DT_BasePlayer", "m_fFlags"); }
    class CBaseCombatWeapon *GetActiveWeapon()
    {
        DYNVAR(n, int, "DT_BaseCombatCharacter",
               "m_hActiveWeapon");
        return (CBaseCombatWeapon *)gInts.EntList->GetClientEntityFromHandle(
            n.getValue(this));
    }
    ...
    {
        DYNVAR_RETURN(Vector, this, "DT_BasePlayer", "localdata",
                      "m_vecViewOffset[0]");
    }
    Vector GetViewPos() { return GetAbsOrigin() + GetViewOffset(); }
    ...
    float GetNextAttack()
    {
        DYNVAR_RETURN(float, this, "DT_BaseCombatWeapon",
    ...
    {
        DYNVAR_RETURN(Vector, this, "DT_BasePlayer", "localdata", "m_Local",
                      "m_vecPunchAngle");
    }
	...
	*/
	int GetRoundState()
    {
        DYNVAR_RETURN(int, this, "DT_TeamplayRoundBasedRulesProxy",
                      "teamplayroundbased_gamerules_data", "m_iRoundState");
    }
    int GetFov() { DYNVAR_RETURN(int, this, "DT_BasePlayer", "m_iFOV"); }
    void SetFov(int fov)
    {
    ...
    float GetAnimTime()
    {
        DYNVAR_RETURN(float, this, "DT_BaseEntity", "AnimTimeMustBeFirst",
                      "m_flAnimTime");
    }
    ...
    {
        DYNVAR_RETURN(int, this, "DT_EconEntity", "m_AttributeManager",
                      "m_Item", "m_iItemDefinitionIndex");
    }
    Vector GetCollideableMinsPrescaled()
    {
        DYNVAR_RETURN(Vector, this, "DT_BaseEntity", "m_Collision",
                      "m_vecMinsPreScaled");
    }
    ...
    {
        DYNVAR(n, Vector, "DT_BasePlayer", "localdata", "m_vecViewOffset[0]");
        return GetAbsOrigin() + (n.getValue(this));
    }
};
